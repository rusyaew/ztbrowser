...
fn render_index_html() -> String {
    ...
    format!(
        "<!DOCTYPE html><html><head><title>ZTBrowser AWS Nitro</title></head><body><h1>Hello from Nitro enclave</h1><p>This HTML page was generated inside the enclave and returned to the parent over <code>vsock</code>.</p><ul><li>workload_id: <code>{}</code></li><li>repo_url: <code>{}</code></li><li>origin: <code>aws nitro enclave</code></li></ul></body></html>",
        workload_id, repo_url
    )
}
